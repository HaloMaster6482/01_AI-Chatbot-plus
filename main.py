...
def mood(name):
    ...
    if "good" in mood:
        print(Fore.YELLOW + f"Wish you a happy day ahead, {name}! 😊")
    elif "bad" in mood:
        print(Fore.YELLOW + f"Hope your day gets better soon, {name}!")
    else:
        print(Fore.YELLOW + f"I understand, {name}.")
...
def chat_again():
    while True:
        ...
        if chat_again == "yes":
            ...
            print(Fore.RED + f"Invalid response. {Fore.YELLOW}Please enter one of the responses shown in the question above.")   
